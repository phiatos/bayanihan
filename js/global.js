...
                // Check if the user is an admin by their role in the database
                // Moved this line up to be used in the new redirection logic
                const isAdmin = userData?.role === "AB ADMIN" || userData?.role === "admin"; // Added "admin" for robustness
...
                }
                ...
                // Prioritize admin redirection if conditions are met
                if (isAdmin && !isFirstLogin && termsAccepted) {
                    ...
                    // Regular login flow: Role-based Redirection for non-admins (ABVN users)
