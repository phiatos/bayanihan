...
//         });
//         // Removed the explicit showTermsModal() call here as onAuthStateChanged will manage it.
//     }
...
//                     showTermsModal();
//                     // Hiding basic info and password form is now handled by showTermsModal()
...
//                     // ADDED: Clear the session storage flag once password is changed
//                     sessionStorage.removeItem('passwordChangePromptShown');
//                     // Show basic info and password form (This will be correctly handled by onAuthStateChanged after reload)
//                     // No need to explicitly set display here as the page reload will re-run the auth check.
//                     // MODIFIED: Redirect to profile page to refresh the view with full profile details
